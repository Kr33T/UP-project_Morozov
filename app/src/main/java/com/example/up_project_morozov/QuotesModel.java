...
public class QuotesModel implements Parcelable {
    ...
    public QuotesModel(int id, String title, String image, String description) {
        this.id = id;
        this.title = title;
        this.image = image;
    ...
    public static final Parcelable.Creator<QuotesModel> CREATOR = new Parcelable.Creator<QuotesModel>() {
        @Override
